...
docker tag stephaneeybert/ubuntuos-postgresql:12.1 europasprak.com:5000/ubuntuos-postgresql:12.1
docker push europasprak.com:5000/ubuntuos-postgresql:12.1
fi
